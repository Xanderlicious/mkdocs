...
NCC-1702 is my primary DNS resolver and provides ad-blocking through Pi-Hole, paired with [Unbound](unbound.md) as a local recursive DNS resolver

![sysinfo](images/1702sysinfo.png)

It is a Raspberry Pi4 4GB and is strapped to the back of the offical Raspberry Pi 7" screen which displays Pi-Hole stats through [PADD](https://docs.xmsystems.co.uk/padd/)
...
![pihole-webui](<images/pi-hole webinterface.png>)
